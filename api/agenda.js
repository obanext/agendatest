export default async function handler(req, res) {
  ...
  const url = `https://zoeken.oba.nl/api/v1/search/?q=table:evenementen&refine=true&authorization=${key}&facet=${wanneerFacet}${branchParam}&sort=evt_dt_asc&pagesize=8`;
